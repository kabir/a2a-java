...
public class ReplicatedQueueManager implements QueueManager {
    ...
    public void onReplicatedEvent(@Observes ReplicatedEvent replicatedEvent) {
        ...
        try {
            ...
            System.out.println("====> onEvent. Has queue: " + queue);
            ...
            if (queue == null) {
                ...
                System.out.println("====> onEvent. No queue found, creating/tapping queue for task: " + replicatedEvent.getTaskId());
            ...
            if (queue != null) {
                ...
                System.out.println("====> onEvent. Sending event " + event);
                if (event != null) {
