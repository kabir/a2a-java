 ...
 * <ul>
 *   <li>{@link org.a2aproject.sdk.server.apps.quarkus.A2AServerRoutes A2AServerRoutes} - Vert.x Web routing and request handling</li>
 *   <li>{@link org.a2aproject.sdk.server.apps.quarkus.CallContextFactory CallContextFactory} - Extension point for custom context creation</li>
 *   <li>{@link org.a2aproject.sdk.server.apps.quarkus.QuarkusJSONRPCTransportMetadata QuarkusJSONRPCTransportMetadata} - Transport protocol identification</li>
 * </ul>
 *
 ...
 * <p>Provide a CDI bean implementing {@link org.a2aproject.sdk.server.apps.quarkus.CallContextFactory CallContextFactory}:
 * <pre>{@code
 * @ApplicationScoped
 ...
 * </pre>
 *
 * @see org.a2aproject.sdk.server.apps.quarkus.A2AServerRoutes
 * @see org.a2aproject.sdk.server.apps.quarkus.CallContextFactory
 * @see org.a2aproject.sdk.transport.jsonrpc.handler.JSONRPCHandler
 */
