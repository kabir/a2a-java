...
/**
 * Authentication tests for JSON-RPC transport with Vert.x HTTP client.
 * <p>
 * Validates that:
 * <ul>
...
public class QuarkusA2AJSONRPCWithAuthVertxTest extends AbstractA2AServerWithAuthTest {

    @Inject
    Vertx vertx;

    public QuarkusA2AJSONRPCWithAuthVertxTest() {
        super(8081);
    }
