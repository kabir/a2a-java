...
/**
 * Authentication tests for REST (HTTP JSON) transport with Vert.x HTTP client.
 * <p>
 * Validates that:
 * <ul>
...
public class QuarkusA2ARestWithAuthVertxTest extends AbstractA2AServerWithAuthTest {

    @Inject
    Vertx vertx;

    public QuarkusA2ARestWithAuthVertxTest() {
        super(8081);
    }
