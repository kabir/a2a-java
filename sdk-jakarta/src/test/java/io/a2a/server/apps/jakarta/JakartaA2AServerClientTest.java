...
@ArquillianTest
@ApplicationScoped
public class JakartaA2AServerClientTest extends AbstractA2AServerClientTest {

    public JakartaA2AServerClientTest() {
        super(8081);
    }
    ...
    public static WebArchive createTestArchive() throws IOException {
        ...
        WebArchive archive = ShrinkWrap.create(WebArchive.class, "ROOT.war")
                ...
                .addClass(AbstractA2AServerClientTest.class)
                .addClass(AgentCardProducer.class)
                .addClass(AgentExecutorProducer.class)
                .addClass(JakartaA2AServerClientTest.class)
