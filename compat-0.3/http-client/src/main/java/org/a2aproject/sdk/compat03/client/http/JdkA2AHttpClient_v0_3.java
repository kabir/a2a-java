...
public class JdkA2AHttpClient_v0_3 implements A2AHttpClient_v0_3 {
    ...
    private class JdkGetBuilder extends JdkBuilder<GetBuilder> implements A2AHttpClient_v0_3.GetBuilder {
    ...
    private class JdkDeleteBuilder extends JdkBuilder<DeleteBuilder> implements A2AHttpClient_v0_3.DeleteBuilder {
    ...
    private class JdkPostBuilder extends JdkBuilder<PostBuilder> implements A2AHttpClient_v0_3.PostBuilder {
        String body = "";
    ...
    private record JdkHttpResponse(HttpResponse<String> response) implements A2AHttpResponse_v0_3 {
