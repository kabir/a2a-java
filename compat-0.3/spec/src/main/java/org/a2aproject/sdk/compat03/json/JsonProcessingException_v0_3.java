 ...
 * {@link JsonMappingException_v0_3}.
 * <p>
 * Usage example:
 * <pre>{@code
 * try {
 ...
 * }</pre>
 *
 * @see JsonMappingException_v0_3 for mapping-specific errors
 */
public class JsonProcessingException_v0_3 extends Exception {
     ...
     */
    public JsonProcessingException_v0_3(String message) {
        super(message);
    }
     ...
     */
    public JsonProcessingException_v0_3(String message, @Nullable Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public JsonProcessingException_v0_3(Throwable cause) {
        super(cause);
    }
}
