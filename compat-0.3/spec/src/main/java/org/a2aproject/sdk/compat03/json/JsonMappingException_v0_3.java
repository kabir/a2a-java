 ...
 * <p>
 * This exception extends {@link JsonProcessingException_v0_3} and is used for more specific
 ...
 * }</pre>
 *
 * @see JsonProcessingException_v0_3 for the base exception class
 */
public class JsonMappingException_v0_3 extends JsonProcessingException_v0_3 {
     ...
     */
    public JsonMappingException_v0_3(@Nullable Object reference, String message) {
        super(message);
     ...
     */
    public JsonMappingException_v0_3(@Nullable Object reference, String message, @Nullable Throwable cause) {
        super(message, cause);
        this.reference = reference;
    }
     ...
     * @param cause the underlying cause of the mapping error (may be null)
     */
    public JsonMappingException_v0_3(String message, @Nullable Throwable cause) {
     ...
     * @param message the detail message explaining the mapping error
     */
    public JsonMappingException_v0_3(String message) {
        this(null, message);
    }
