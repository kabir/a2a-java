...
/**
 * Exposes the {@link TestUtilsBean_v0_3} via JAX-RS REST endpoints for testing the gRPC server.
 * Uses JAX-RS instead of Reactive Routes because gRPC servers typically expose REST test utilities separately.
 */
@Path("/test")
@ApplicationScoped
public class A2ATestResource_v0_3 {
    @Inject
