...
public interface EventKindMapper_v0_3 {

    /**
     * Singleton instance accessed via {@link A2AMappers_v0_3} factory.
     */
    EventKindMapper_v0_3 INSTANCE = A2AMappers_v0_3.getMapper(EventKindMapper_v0_3.class);
     ...
     */
    default EventKind toV10(EventKind_v0_3 v03) {
        if (v03 == null) {
            return null;
        }
     ...
     * @throws InvalidRequestError if the event kind type is unrecognized
     */
    default EventKind_v0_3 fromV10(EventKind v10) {
        if (v10 == null) {
            return null;
        }
