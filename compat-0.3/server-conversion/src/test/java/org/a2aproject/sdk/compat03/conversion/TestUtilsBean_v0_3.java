...
/**
 * Contains utilities to interact with the server side for the v0.3 compat tests.
 * Duplicated from v1.0 tests/server-common to avoid dependency on v1.0 test infrastructure.
 *
 * <p>The intent for this bean is to be exposed via REST.
 *
...
@ApplicationScoped
@IfBuildProfile("test")
public class TestUtilsBean_v0_3 {
