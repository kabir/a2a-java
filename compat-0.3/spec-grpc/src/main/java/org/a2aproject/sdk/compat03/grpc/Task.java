...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.a2aproject.sdk.compat03.grpc.Task result) {
      if (artifactsBuilder_ == null) {
    ...
    private void buildPartial0(org.a2aproject.sdk.compat03.grpc.Task result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              org.a2aproject.sdk.compat03.grpc.Artifact m =
                  input.readMessage(
                      org.a2aproject.sdk.compat03.grpc.Artifact.parser(),
                      extensionRegistry);
              if (artifactsBuilder_ == null) {
                ensureArtifactsIsMutable();
                artifacts_.add(m);
            ...
            case 42: {
              org.a2aproject.sdk.compat03.grpc.Message m =
                  input.readMessage(
                      org.a2aproject.sdk.compat03.grpc.Message.parser(),
                      extensionRegistry);
              if (historyBuilder_ == null) {
                ensureHistoryIsMutable();
                history_.add(m);
    ...
    public Builder mergeStatus(org.a2aproject.sdk.compat03.grpc.TaskStatus value) {
      if (statusBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          status_ != null &&
          status_ != org.a2aproject.sdk.compat03.grpc.TaskStatus.getDefaultInstance()) {
