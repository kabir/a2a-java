  ...
  private int computeSerializedSize_0() {
    ...
    for (java.util.Map.Entry<java.lang.String, org.a2aproject.sdk.compat03.grpc.SecurityScheme> entry
      ...
      size += com.google.protobuf.CodedOutputStream
        ...
        {
          final int count = security_.size();
          for (int i = 0; i < count; i++) {
            size += com.google.protobuf.CodedOutputStream
              .computeMessageSizeNoTag(security_.get(i));
          }
          size += 1 * count;
        }
    {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(preferredTransport_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(14, preferredTransport_);
        ...
        {
          final int count = additionalInterfaces_.size();
          for (int i = 0; i < count; i++) {
            size += com.google.protobuf.CodedOutputStream
              .computeMessageSizeNoTag(additionalInterfaces_.get(i));
          }
          size += 1 * count;
        }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(protocolVersion_)) {
