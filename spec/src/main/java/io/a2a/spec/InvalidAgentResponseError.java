...
public class InvalidAgentResponseError extends JSONRPCError {
    ...
    public final static Integer DEFAULT_CODE = A2AErrorCodes.INVALID_AGENT_RESPONSE_ERROR_CODE;

    public InvalidAgentResponseError(Integer code, String message, Object data) {
        super(
                defaultIfNull(code, A2AErrorCodes.INVALID_AGENT_RESPONSE_ERROR_CODE),
